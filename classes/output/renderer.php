...
/**
 * Nct tabs module base render to update the core components.
 *
 * @package    mod_slides
...
class renderer extends core_renderer {
     ...
     */
    public function activity_navigation($ncttabs=0, $context=null)
    {
        ...
        if ($ncttabs) {
            list($course, $cm) = get_course_and_cm_from_instance($ncttabs, 'ncttabs');
        } else {
