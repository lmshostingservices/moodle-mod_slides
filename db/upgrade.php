...
function xmldb_slides_upgrade($oldversion) {
    ...
    //   version.php -> 2026042300.
    if ($oldversion < 2026042300) {
        upgrade_mod_savepoint(true, 2026042300, 'slides');
    }

    if ($oldversion < 2026061800) {
        upgrade_mod_savepoint(true, 2026061800, 'slides');
    }
    ...
    if ($oldversion < 2026071701) {
        ...
        upgrade_mod_savepoint(true, 2026071701, 'slides');
    }
    ...
    if ($oldversion < 2026072300) {
        ...
        upgrade_mod_savepoint(true, 2026072300, 'slides');
    }
