...
require_once($CFG->dirroot . '/mod/slides/backup/moodle2/backup_slides_stepslib.php');
...
class backup_slides_activity_task extends backup_activity_task {
    ...
    public function define_my_settings() {
        // Slides don't have any specified settings.
    }

    /**
     * Define backup structure steps to store the instance data in the slides.xml.
     */
    public function define_my_steps() {
        // Only single structure step.
        $this->add_step(new backup_slides_activity_structure_step('slides_structure', 'slides.xml'));
    }
